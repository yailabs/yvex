...
typedef enum {
    ...
    YVEX_CLIENT_OP_ENGINE_LEASE_RELEASE, YVEX_CLIENT_OP_EXECUTION_PREFLIGHT, YVEX_CLIENT_OP_FINITE_DECISION
...
typedef enum {
    ...
    YVEX_CLIENT_MESSAGE_ENGINE, YVEX_CLIENT_MESSAGE_PREFLIGHT, YVEX_CLIENT_MESSAGE_FINITE_DECISION
