/*
 * yvex_cli_runtime.c - Private command implementations for the YVEX CLI.
 *
 * yvex_cli.c keeps the command table and dispatch. This module keeps the
 * command bodies and proof/report helpers behind that private surface.
 */
...
static int command_integrity(int argc, char **argv)
{
    ...
    if (argc >= 3 && (strcmp(argv[2], "--help") == 0 || strcmp(argv[2], "-h") == 0)) {
        yvex_cli_print_command_help(stdout, yvex_cli_find_command("integrity"));
        return 0;
    }
...
static int command_inspect(int argc, char **argv)
{
    ...
    if (argc != 3 || strcmp(argv[2], "--help") == 0 || strcmp(argv[2], "-h") == 0) {
        if (argc == 3) {
            yvex_cli_print_command_help(stdout, yvex_cli_find_command("inspect"));
            return 0;
        }
...
static int command_metadata(int argc, char **argv)
{
    ...
    if (argc != 3 || strcmp(argv[2], "--help") == 0 || strcmp(argv[2], "-h") == 0) {
        if (argc == 3) {
            yvex_cli_print_command_help(stdout, yvex_cli_find_command("metadata"));
            return 0;
        }
...
static int command_materialize(int argc, char **argv)
{
    ...
    if (argc == 3 && (strcmp(argv[2], "--help") == 0 || strcmp(argv[2], "-h") == 0)) {
        yvex_cli_print_command_help(stdout, yvex_cli_find_command("materialize"));
        return 0;
    }
...
static int command_materialize_gate(int argc, char **argv)
{
    ...
    if (argc >= 3 && (strcmp(argv[2], "--help") == 0 || strcmp(argv[2], "-h") == 0)) {
        yvex_cli_print_command_help(stdout, yvex_cli_find_command("materialize-gate"));
        return 0;
    }
    if (argc < 3 || strcmp(argv[2], "check") != 0) {
...
static int command_model_gate(int argc, char **argv)
{
    ...
    if (argc >= 3 && (strcmp(argv[2], "--help") == 0 || strcmp(argv[2], "-h") == 0)) {
        yvex_cli_print_command_help(stdout, yvex_cli_find_command("model-gate"));
        return 0;
    }
    if (argc < 3 || strcmp(argv[2], "check") != 0) {
...
static int command_tensors(int argc, char **argv)
{
    ...
    if (argc != 3 || strcmp(argv[2], "--help") == 0 || strcmp(argv[2], "-h") == 0) {
        if (argc == 3) {
            yvex_cli_print_command_help(stdout, yvex_cli_find_command("tensors"));
            return 0;
        }
