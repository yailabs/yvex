 ...
 */
#include "deepseek_attention_reference.h"
...
static int ref_rolling_export(
    ...
    yvex_deepseek_attention_rolling_state_output *out)
{
    unsigned long long extent;
...
static int ref_compressor_execute(
    ...
    yvex_deepseek_attention_rolling_state_output *next_state,
    char reason[YVEX_TEST_ATTENTION_REFERENCE_REASON_CAP])
{
    ...
    char reason[YVEX_TEST_ATTENTION_REFERENCE_REASON_CAP])
{
    ...
    yvex_deepseek_attention_rolling_state_output next_main_state;
    yvex_deepseek_attention_rolling_state_output next_indexer_state;
...
static int ref_compare_rolling_state(
    const char *stage,
    const yvex_deepseek_attention_rolling_state_output *production,
    const yvex_deepseek_attention_rolling_state_output *reference,
    double absolute_tolerance,
    double relative_tolerance,
    yvex_test_attention_reference_metrics *metrics)
{
...
int yvex_test_attention_reference_compare(
    const yvex_deepseek_attention_execution_trace *production,
    const yvex_deepseek_attention_execution_trace *reference,
    double absolute_tolerance,
    double relative_tolerance,
    yvex_test_attention_reference_metrics *metrics)
{
