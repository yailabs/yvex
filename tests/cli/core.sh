...
contains "$OUT_DIR/source_manifest_report_missing_source.out" "next: TENSOR.COLLECTION.GEMMA.0"
...
matches "$OUT_DIR/source_manifest_report_table.out" '^qwen[[:space:]]{2,}qwen3-8b[[:space:]]{2,}missing[[:space:]]{2,}0[[:space:]]{2,}missing[[:space:]]{2,}not-checked[[:space:]]{2,}TENSOR\.COLLECTION\.GEMMA\.0$'
...
contains "$OUT_DIR/source_manifest_report_audit.out" "next_required_rows: TENSOR.COLLECTION.GEMMA.0"
...
contains "$OUT_DIR/source_manifest_report_gemma_missing_source.out" "next: TENSOR.COLLECTION.GEMMA.0"
...
matches "$OUT_DIR/source_manifest_report_gemma_table.out" '^gemma[[:space:]]{2,}gemma-4-12b-it[[:space:]]{2,}missing[[:space:]]{2,}0[[:space:]]{2,}missing[[:space:]]{2,}not-checked[[:space:]]{2,}TENSOR\.COLLECTION\.GEMMA\.0$'
...
contains "$OUT_DIR/source_manifest_report_gemma_audit.out" "next_required_rows: TENSOR.COLLECTION.GEMMA.0"
...
contains "$OUT_DIR/source_manifest_report_fake_source.out" "next: TENSOR.COLLECTION.GEMMA.0"
...
matches "$OUT_DIR/source_manifest_report_fake_source_table.out" '^qwen[[:space:]]{2,}qwen3-8b[[:space:]]{2,}present[[:space:]]{2,}2[[:space:]]{2,}missing[[:space:]]{2,}not-checked[[:space:]]{2,}TENSOR\.COLLECTION\.GEMMA\.0$'
...
contains "$OUT_DIR/source_manifest_report_fake_manifest.out" "next: TENSOR.COLLECTION.GEMMA.0"
...
matches "$OUT_DIR/source_manifest_report_fake_manifest_table.out" '^qwen[[:space:]]{2,}qwen3-8b[[:space:]]{2,}present[[:space:]]{2,}1[[:space:]]{2,}present[[:space:]]{2,}partial[[:space:]]{2,}TENSOR\.COLLECTION\.GEMMA\.0$'
...
contains "$OUT_DIR/source_manifest_report_broken_safetensors.out" "next: TENSOR.COLLECTION.GEMMA.0"
...
contains "$OUT_DIR/model_target_candidate.out" "next: TENSOR.COLLECTION.GEMMA.0"
...
matches "$OUT_DIR/model_target_candidate_table.out" '^full-runtime-candidate[[:space:]]{2,}missing[[:space:]]{2,}none[[:space:]]{2,}0[[:space:]]{2,}TENSOR\.COLLECTION\.GEMMA\.0$'
...
contains "$OUT_DIR/model_target_dense_candidate.out" "next: TENSOR.COLLECTION.GEMMA.0"
...
matches "$OUT_DIR/model_target_dense_candidate_table.out" '^dense-candidate[[:space:]]{2,}missing[[:space:]]{2,}none[[:space:]]{2,}0[[:space:]]{2,}TENSOR\.COLLECTION\.GEMMA\.0$'
...
contains "$OUT_DIR/model_target_dense_candidate_gemma.out" "dense_candidate_0_next_required_rows: V010.TARGET.7,TENSOR.COLLECTION.GEMMA.0"
...
contains "$OUT_DIR/model_target_qwen_metal.out" "next: TENSOR.COLLECTION.GEMMA.0"
...
matches "$OUT_DIR/model_target_qwen_metal_table.out" '^qwen-metal-pressure[[:space:]]{2,}pressure[[:space:]]{2,}none[[:space:]]{2,}0[[:space:]]{2,}TENSOR\.COLLECTION\.GEMMA\.0$'
...
contains "$OUT_DIR/model_target_qwen_metal_full.out" "next_required_rows: TENSOR.COLLECTION.GEMMA.0"
...
contains "$OUT_DIR/model_target_qwen_metal_small.out" "next_required_rows: TENSOR.COLLECTION.GEMMA.0"
...
contains "$OUT_DIR/model_target_qwen.out" "next: TENSOR.COLLECTION.GEMMA.0"
...
contains "$OUT_DIR/model_target_gemma.out" "next: TENSOR.COLLECTION.GEMMA.0"
