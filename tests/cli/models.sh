...
grep 'deepseek[[:space:]][[:space:]]*deepseek4-v4-flash[[:space:]][[:space:]]*blocked[[:space:]][[:space:]]*[1-9][0-9]*[[:space:]][[:space:]]*[1-9][0-9]*[[:space:]][[:space:]]*gguf-writer-missing[[:space:]][[:space:]]*V010.GGUF.WRITER.1' "$ROOT/qtype-role-support-gate-table.out"
...
grep 'family.0.top_blocker: gguf-writer-missing' "$ROOT/qtype-role-support-gate-audit.out"
...
grep 'top_blocker: gguf-writer-missing' "$ROOT/qtype-role-support-deepseek-selected.out"
grep 'next: V010.GGUF.WRITER.1' "$ROOT/qtype-role-support-deepseek-selected.out"
...
grep 'role\.[0-9][0-9]*\.artifact_emission_blocker: gguf-writer-missing' "$ROOT/qtype-role-support-deepseek-selected-audit.out"
