...
grep 'gate: v0.1.0-tensor-mapping' "$ROOT/tensor-mapping-gate-qwen.out"
grep 'status: passed-for-artifact-planning' "$ROOT/tensor-mapping-gate-qwen.out"
grep 'target_id: qwen3-8b' "$ROOT/tensor-mapping-gate-qwen.out"
grep 'family: qwen' "$ROOT/tensor-mapping-gate-qwen.out"
grep 'tensor_naming_map: naming-map-profiled' "$ROOT/tensor-mapping-gate-qwen.out"
grep 'output_head_map: output-head-profiled' "$ROOT/tensor-mapping-gate-qwen.out"
grep 'tokenizer_metadata_map: tokenizer-metadata-profiled' "$ROOT/tensor-mapping-gate-qwen.out"
grep 'missing_role_report: missing-role-report-blocked' "$ROOT/tensor-mapping-gate-qwen.out"
grep 'source_roles: observed=12 required=12 missing=0 ambiguous=0' "$ROOT/tensor-mapping-gate-qwen.out"
grep 'metadata_roles: observed=4 required=4 missing=0 ambiguous=0' "$ROOT/tensor-mapping-gate-qwen.out"
grep 'missing_roles: none' "$ROOT/tensor-mapping-gate-qwen.out"
grep 'ambiguous_roles: none' "$ROOT/tensor-mapping-gate-qwen.out"
grep 'gate_result: pass' "$ROOT/tensor-mapping-gate-qwen.out"
...
grep 'runtime_claim: unsupported' "$ROOT/tensor-mapping-gate-qwen.out"
grep 'generation: unsupported-full-model' "$ROOT/tensor-mapping-gate-qwen.out"
grep 'benchmark_status: not-measured' "$ROOT/tensor-mapping-gate-qwen.out"
grep 'release_ready: false' "$ROOT/tensor-mapping-gate-qwen.out"
grep 'report-only tensor mapping gate' "$ROOT/tensor-mapping-gate-qwen.out"
...
matches "$ROOT/tensor-mapping-gate-qwen-table.out" '^TARGET[[:space:]]{2,}FAMILY[[:space:]]{2,}GATE[[:space:]]{2,}SOURCE_ROLES[[:space:]]{2,}METADATA_ROLES[[:space:]]{2,}MISSING[[:space:]]{2,}AMBIGUOUS[[:space:]]{2,}STATUS[[:space:]]{2,}NEXT$'
matches "$ROOT/tensor-mapping-gate-qwen-table.out" '^qwen3-8b[[:space:]]{2,}qwen[[:space:]]{2,}v0\.1\.0-tensor-mapping[[:space:]]{2,}12/12[[:space:]]{2,}4/4[[:space:]]{2,}0[[:space:]]{2,}0[[:space:]]{2,}passed-for-artifact-planning[[:space:]]{2,}V010\.QUANT\.0$'
grep 'runtime_claim: unsupported' "$ROOT/tensor-mapping-gate-qwen-table.out"
grep 'release_ready: false' "$ROOT/tensor-mapping-gate-qwen-table.out"
...
grep 'status: passed-for-artifact-planning' "$ROOT/tensor-mapping-gate-gemma.out"
grep 'target_id: gemma-4-12b-it' "$ROOT/tensor-mapping-gate-gemma.out"
grep 'family: gemma' "$ROOT/tensor-mapping-gate-gemma.out"
...
matches "$ROOT/tensor-mapping-gate-gemma-table.out" '^gemma-4-12b-it[[:space:]]{2,}gemma[[:space:]]{2,}v0\.1\.0-tensor-mapping[[:space:]]{2,}12/12[[:space:]]{2,}4/4[[:space:]]{2,}0[[:space:]]{2,}0[[:space:]]{2,}passed-for-artifact-planning[[:space:]]{2,}V010\.QUANT\.0$'
...
grep 'status: blocked-missing-runtime-roles' "$ROOT/tensor-mapping-gate-qwen-no-k.out"
grep 'missing_roles: attention_k' "$ROOT/tensor-mapping-gate-qwen-no-k.out"
...
grep 'status: blocked-missing-output-head' "$ROOT/tensor-mapping-gate-qwen-no-head.out"
grep 'missing_roles: output_head' "$ROOT/tensor-mapping-gate-qwen-no-head.out"
...
grep 'status: blocked-missing-tokenizer-metadata' "$ROOT/tensor-mapping-gate-qwen-no-metadata.out"
grep 'missing_roles: tokenizer_metadata,config_metadata,generation_metadata,special_tokens' "$ROOT/tensor-mapping-gate-qwen-no-metadata.out"
...
grep 'status: blocked-ambiguous-output-head' "$ROOT/tensor-mapping-gate-qwen-ambiguous.out"
grep 'ambiguous_roles: output_head' "$ROOT/tensor-mapping-gate-qwen-ambiguous.out"
...
grep 'status: blocked-missing-source' "$ROOT/tensor-mapping-gate-qwen-missing-source.out"
...
grep 'status: blocked-missing-source' "$ROOT/tensor-mapping-gate-gemma-missing-source.out"
...
grep 'report: qtype-policy' "$ROOT/qtype-policy-qwen.out"
grep 'status: policy-reported' "$ROOT/qtype-policy-qwen.out"
grep 'target_id: qwen3-8b' "$ROOT/qtype-policy-qwen.out"
grep 'family: qwen' "$ROOT/qtype-policy-qwen.out"
grep 'mapping_gate: passed-for-artifact-planning' "$ROOT/qtype-policy-qwen.out"
grep 'policy_basis: header-only-source-metadata+existing-yvex-policy-table' "$ROOT/qtype-policy-qwen.out"
grep 'source_dtype_profile: F32=12 F16=0 BF16=0 other=0' "$ROOT/qtype-policy-qwen.out"
grep 'qtype_policy: artifact-planning-storage-policy' "$ROOT/qtype-policy-qwen.out"
grep 'preferred_qtype: F16' "$ROOT/qtype-policy-qwen.out"
grep 'candidate_qtypes: F16,BF16,F32' "$ROOT/qtype-policy-qwen.out"
grep 'refused_qtypes: Q8_0,Q4_K,Q2_K,IQ2_XXS' "$ROOT/qtype-policy-qwen.out"
grep 'calibration_status: deferred-to-V010.QUANT.3' "$ROOT/qtype-policy-qwen.out"
grep 'imatrix_status: deferred-to-V010.QUANT.3' "$ROOT/qtype-policy-qwen.out"
grep 'per_role_qtype_status: deferred-to-V010.QUANT.1' "$ROOT/qtype-policy-qwen.out"
grep 'compute_support_status: deferred-to-V010.QUANT.2' "$ROOT/qtype-policy-qwen.out"
grep 'artifact_emit_status: blocked-until-artifact-emitter' "$ROOT/qtype-policy-qwen.out"
...
grep 'runtime_claim: unsupported' "$ROOT/qtype-policy-qwen.out"
grep 'generation: unsupported-full-model' "$ROOT/qtype-policy-qwen.out"
grep 'benchmark_status: not-measured' "$ROOT/qtype-policy-qwen.out"
grep 'release_ready: false' "$ROOT/qtype-policy-qwen.out"
grep 'report-only qtype policy report' "$ROOT/qtype-policy-qwen.out"
...
matches "$ROOT/qtype-policy-qwen-table.out" '^TARGET[[:space:]]{2,}FAMILY[[:space:]]{2,}SOURCE_DTYPE[[:space:]]{2,}POLICY[[:space:]]{2,}PREFERRED[[:space:]]{2,}CANDIDATES[[:space:]]{2,}REFUSED[[:space:]]{2,}CALIBRATION[[:space:]]{2,}STATUS[[:space:]]{2,}NEXT$'
matches "$ROOT/qtype-policy-qwen-table.out" '^qwen3-8b[[:space:]]{2,}qwen[[:space:]]{2,}F32=12 F16=0 BF16=0 other=0[[:space:]]{2,}artifact-planning-storage-policy[[:space:]]{2,}F16[[:space:]]{2,}F16,BF16,F32[[:space:]]{2,}Q8_0,Q4_K,Q2_K,IQ2_XXS[[:space:]]{2,}deferred-to-V010\.QUANT\.3[[:space:]]{2,}policy-reported[[:space:]]{2,}V010\.QUANT\.1$'
...
grep 'status: policy-reported' "$ROOT/qtype-policy-gemma.out"
grep 'target_id: gemma-4-12b-it' "$ROOT/qtype-policy-gemma.out"
grep 'family: gemma' "$ROOT/qtype-policy-gemma.out"
grep 'source_dtype_profile: F32=12 F16=0 BF16=0 other=0' "$ROOT/qtype-policy-gemma.out"
grep 'preferred_qtype: F16' "$ROOT/qtype-policy-gemma.out"
...
matches "$ROOT/qtype-policy-gemma-table.out" '^gemma-4-12b-it[[:space:]]{2,}gemma[[:space:]]{2,}F32=12 F16=0 BF16=0 other=0[[:space:]]{2,}artifact-planning-storage-policy[[:space:]]{2,}F16[[:space:]]{2,}F16,BF16,F32[[:space:]]{2,}Q8_0,Q4_K,Q2_K,IQ2_XXS[[:space:]]{2,}deferred-to-V010\.QUANT\.3[[:space:]]{2,}policy-reported[[:space:]]{2,}V010\.QUANT\.1$'
...
grep 'status: blocked-missing-source' "$ROOT/qtype-policy-qwen-missing-source.out"
grep 'mapping_gate: blocked-missing-source' "$ROOT/qtype-policy-qwen-missing-source.out"
...
grep 'status: blocked-missing-source-dtype-profile' "$ROOT/qtype-policy-qwen-missing-dtype.out"
grep 'source_dtype_profile: F32=0 F16=0 BF16=0 other=0' "$ROOT/qtype-policy-qwen-missing-dtype.out"
...
grep 'status: blocked-mapping-gate' "$ROOT/qtype-policy-qwen-blocked-gate.out"
grep 'mapping_gate: blocked-missing-runtime-roles' "$ROOT/qtype-policy-qwen-blocked-gate.out"
...
grep 'status: unsupported-target' "$ROOT/qtype-policy-unknown-target.out"
"$YVEX_BIN" model-target quant-policy deepseek4-v4-flash-selected-embed > "$ROOT/qtype-policy-unsupported-class.out"
grep 'status: blocked-unsupported-target-class' "$ROOT/qtype-policy-unsupported-class.out"
...
grep 'status: unsupported-family' "$ROOT/qtype-policy-unsupported-family.out"
