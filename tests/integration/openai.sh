#!/bin/sh
# Exercises production HTTP/SSE translation over the real local protocol v24 codec.
set -eu
...
echo 'OpenAI adapter integration: protocol-v24 Chat/Responses/SSE/tool/state/cleanup/refusal passed'
