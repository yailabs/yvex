#!/bin/sh
# Exercises production HTTP/SSE translation over the real local protocol v22 codec.
set -eu
...
echo 'OpenAI adapter integration: protocol-v22 Chat/Responses/SSE/tool/state/cleanup/refusal passed'
