#!/bin/sh
# Exercises production HTTP/SSE translation over the real local protocol v23 codec.
set -eu
...
echo 'OpenAI adapter integration: protocol-v23 Chat/Responses/SSE/tool/state/cleanup/refusal passed'
