...
grep -nF 'yvex_deepseek_attention_history_validate' src/graph/yvex_deepseek_attention_compressor.c >/dev/null
grep -nF 'yvex_deepseek_attention_state_delta_begin' src/graph/yvex_deepseek_attention_sink.c >/dev/null
...
grep -nF 'runtime_numeric_identity=' tests/live/attention_deepseek.c >/dev/null
grep -nF 'descriptor_summary->generation_ready' tests/live/materialize_deepseek.c >/dev/null
grep -nF 'attention_execution_supported=' tests/live/attention_deepseek.c >/dev/null
grep -nF 'yvex_deepseek_attention_execute_supported' tests/live/attention_deepseek.c >/dev/null
...
grep -nF 'yvex_materialization_session_read' src/graph/yvex_deepseek_attention_execute.c >/dev/null
grep -nF 'yvex_quant_cpu_dot' src/graph/yvex_deepseek_attention_execute.c >/dev/null
grep -nF 'attention_cpu_probe_payload_bytes_read=' tests/live/attention_deepseek.c >/dev/null
grep -nF 'attention_cpu_first_token_payload_bytes_read=' tests/live/attention_deepseek.c >/dev/null
grep -nF 'attention_cpu_first_token.layer.%llu.full_attention' tests/live/attention_deepseek.c >/dev/null
...
attention_claim_pattern='generation_ready[[:space:]]*=[[:space:]]*1|runtime_generation_ready=1|runtime generation ready|generation support|inference ready|attention_cpu_probe_full_attention=1'
if git grep -nE "$attention_claim_pattern" -- \
  ...
  echo "DeepSeek attention admission must not claim generation or full-runtime support"
  exit 1
fi
