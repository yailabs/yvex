...
imatrix manifests: ~/lab/manifests/<family>
external imatrix artifacts: ~/lab/artifacts/reference-layouts/*.dat
```
...
now. External `.dat` calibration artifacts, including routed-MoE imatrix
