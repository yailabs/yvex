...
- `source-manifest report --audit`: source artifact class/status, target artifact class/status, origin/authority, provenance, sidecar, tensor container, source footprint, and payload-read boundary fields
