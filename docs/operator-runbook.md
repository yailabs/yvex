...
accounting, explicit stop-policy reporting, and bounded trace-level reporting
over the implemented selected segment path. It still does not implement full
