...
/* Domain-owned command surface moved from yvex_runtime_commands.c. */
...
{
    fprintf(fp, "usage: yvex paths [--project DIR] [--run] [--create]\n\nPrints resolved runtime filesystem paths and can create a run directory.\n");
}
