/*
 * yvex_cli_commands.c - Private command catalog and help surface.
 *
 * This module owns command metadata and help rendering. The entrypoint in
 * yvex_cli.c only performs top-level dispatch.
 */
