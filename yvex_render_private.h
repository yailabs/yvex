/*
 * yvex_render_private.h - Private CLI rendering helpers.
 *
 * Domain owner files build semantic reports; this header owns small reusable
 * text rendering primitives for porcelain, table, and audit output. It is not
 * a public API and does not implement JSON, color, or command behavior.
 */
#ifndef YVEX_RENDER_PRIVATE_H
#define YVEX_RENDER_PRIVATE_H
