                                 ...
                                 const char *status)
{
    ...
    fprintf(stdout, "decode: step\n");
    fprintf(stdout, "status: decode-step\n");
    ...
    fprintf(stdout, "prefill_tokens_processed: %llu\n",
           summary ? summary->prefill_tokens_processed : 0ull);
    fprintf(stdout, "prefill_position_start: %llu\n",
    ...
    fprintf(stdout, "real_model_decode: false\n");
    fprintf(stdout, "full_model_decode_ready: false\n");
