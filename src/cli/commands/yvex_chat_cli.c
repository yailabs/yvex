...
int yvex_run_command_json(FILE *fp, const yvex_chat_accept_result *result)
{
    ...
    yvex_cli_out_writef(fp, ",\n");
    yvex_cli_out_writef(fp, "    \"session_state\": ");
    ...
    yvex_cli_out_writef(fp, "    \"position\": %llu,\n", result->position);
    yvex_cli_out_writef(fp, "    \"execution_ready\": false,\n");
    yvex_cli_out_writef(fp, "    \"generation\": ");
    json_print_escaped(fp, result->generation);
    yvex_cli_out_writef(fp, ",\n");
    yvex_cli_out_writef(fp, "    \"reason\": ");
    json_print_escaped(fp, result->reason);
    yvex_cli_out_writef(fp, ",\n");
    yvex_cli_out_writef(fp, "    \"metrics\": {\n");
    yvex_cli_out_writef(fp, "      \"prompt_tokens\": %llu,\n", result->prompt_tokens);
    yvex_cli_out_writef(fp, "      \"accepted_tokens\": %llu\n", result->accepted_tokens);
    yvex_cli_out_writef(fp, "    }");
    ...
    yvex_cli_out_writef(fp, "\n");
    yvex_cli_out_writef(fp, "  },\n");
    yvex_cli_out_writef(fp, "  \"error\": null\n");
    yvex_cli_out_writef(fp, "}\n");
    return YVEX_OK;
}
                           ...
                           unsigned long long position)
{
    ...
    yvex_cli_out_writef(fp, "[%s] tokens=%llu position=%llu\n", phase, tokens, position);
    return YVEX_OK;
}
