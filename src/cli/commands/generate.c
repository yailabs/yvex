...
static const char *const literal_lines_0[] = {"full_transformer_prefill_ready: false",
                                              "decode_ready: false", "logits_ready: false",
                                              "generation_ready: false", "generation: unsupported"};
...
static const yvex_render_field_spec prefill_identity_fields[] = {
    SUMMARY_FIELD("prefill_state_created", prefill_state_created, YVEX_RENDER_FIELD_BOOL, NULL),
    SUMMARY_FIELD("prefill_state_kind", prefill_state_kind, YVEX_RENDER_FIELD_TEXT,
                  "segment-summary"),
    SUMMARY_FIELD("sequence_execution_mode", sequence_execution_mode, YVEX_RENDER_FIELD_TEXT,
                  "independent-token-segments"),
    SUMMARY_FIELD("prefill_phase", prefill_phase, YVEX_RENDER_FIELD_TEXT, "preflight")};
...
static const yvex_render_field_spec prefill_execution_fields[] = {
    ...
    SUMMARY_FIELD("tokens_processed", tokens_processed, YVEX_RENDER_FIELD_U64, NULL),
    ...
    SUMMARY_FIELD("failed_token_index", failed_token_index, YVEX_RENDER_FIELD_U64, NULL),
    SUMMARY_FIELD("context_boundary_status", context_boundary_status, YVEX_RENDER_FIELD_TEXT,
                  "unchecked"),
    SUMMARY_FIELD("context_length", context_length, YVEX_RENDER_FIELD_U64, NULL),
    SUMMARY_FIELD("chunked_prefill_requested", chunked_prefill_requested, YVEX_RENDER_FIELD_BOOL,
                  NULL),
    SUMMARY_FIELD("chunk_execution_mode", chunk_execution_mode, YVEX_RENDER_FIELD_TEXT,
                  "token-loop"),
    ...
    SUMMARY_FIELD("failed_chunk_index", failed_chunk_index, YVEX_RENDER_FIELD_U64, NULL),
    SUMMARY_FIELD("current_chunk_start", current_chunk_start, YVEX_RENDER_FIELD_U64, NULL),
    SUMMARY_FIELD("current_chunk_end", current_chunk_end, YVEX_RENDER_FIELD_U64, NULL),
    SUMMARY_FIELD("final_chunk_checksum", final_chunk_checksum, YVEX_RENDER_FIELD_U64, NULL),
    SUMMARY_FIELD("prefill_scratch_kind", prefill_scratch_kind, YVEX_RENDER_FIELD_TEXT,
                  "host-diagnostic-reuse"),
    SUMMARY_FIELD("prefill_scratch_reuse", prefill_scratch_reuse, YVEX_RENDER_FIELD_BOOL, NULL),
    SUMMARY_FIELD("prefill_scratch_allocations", prefill_scratch_allocations, YVEX_RENDER_FIELD_U64,
                  NULL),
    SUMMARY_FIELD("prefill_scratch_reuse_count", prefill_scratch_reuse_count, YVEX_RENDER_FIELD_U64,
                  NULL),
    SUMMARY_FIELD("prefill_scratch_cleanup_attempted", prefill_scratch_cleanup_attempted,
    ...
    SUMMARY_FIELD("segment_graph_executions", segment_graph_executions, YVEX_RENDER_FIELD_U64,
                  NULL),
    SUMMARY_FIELD("segment_output_count", segment_output_count, YVEX_RENDER_FIELD_U64, NULL),
    SUMMARY_FIELD("segment_output_bytes", segment_output_bytes, YVEX_RENDER_FIELD_U64, NULL),
    SUMMARY_FIELD("prefill_aggregate_checksum", aggregate_checksum, YVEX_RENDER_FIELD_U64, NULL),
    SUMMARY_FIELD("prefill_final_token_checksum", final_token_checksum, YVEX_RENDER_FIELD_U64,
                  NULL),
    SUMMARY_FIELD("prefill_total_output_bytes", total_output_bytes, YVEX_RENDER_FIELD_U64, NULL),
    SUMMARY_FIELD("prefill_scratch_bytes", scratch_bytes, YVEX_RENDER_FIELD_U64, NULL),
    SUMMARY_FIELD("prefill_max_abs_diff", max_abs_diff, YVEX_RENDER_FIELD_DOUBLE, NULL),
    SUMMARY_FIELD("layer_prefill_requested", layer_prefill_requested, YVEX_RENDER_FIELD_BOOL, NULL),
    SUMMARY_FIELD("layer_execution_kind", layer_execution_kind, YVEX_RENDER_FIELD_TEXT, "none"),
    SUMMARY_FIELD("model_layer_execution", model_layer_execution, YVEX_RENDER_FIELD_BOOL, NULL),
    SUMMARY_FIELD("layer_input_projection", layer_input_projection, YVEX_RENDER_FIELD_TEXT, "none"),
    SUMMARY_FIELD("layer_handoff", layer_handoff, YVEX_RENDER_FIELD_TEXT, "none"),
    SUMMARY_FIELD("layer_sequence_rebuild", layer_sequence_rebuild, YVEX_RENDER_FIELD_TEXT, "none"),
    SUMMARY_FIELD("layer_count", layer_count, YVEX_RENDER_FIELD_U64, NULL),
    SUMMARY_FIELD("layer_graph_executions", layer_graph_executions, YVEX_RENDER_FIELD_U64, NULL),
    SUMMARY_FIELD("layer_block_executions", layer_block_executions, YVEX_RENDER_FIELD_U64, NULL),
    SUMMARY_FIELD("layer_total_op_count", layer_total_op_count, YVEX_RENDER_FIELD_U64, NULL),
    SUMMARY_FIELD("layer_output_count", layer_output_count, YVEX_RENDER_FIELD_U64, NULL),
    SUMMARY_FIELD("layer_output_bytes", layer_output_bytes, YVEX_RENDER_FIELD_U64, NULL),
    SUMMARY_FIELD("layer_total_output_bytes", layer_total_output_bytes, YVEX_RENDER_FIELD_U64,
                  NULL),
    SUMMARY_FIELD("layer_total_scratch_bytes", layer_total_scratch_bytes, YVEX_RENDER_FIELD_U64,
                  NULL),
    SUMMARY_FIELD("layer_final_checksum", layer_final_checksum, YVEX_RENDER_FIELD_U64, NULL),
    SUMMARY_FIELD("layer_final_reference_checksum", layer_final_reference_checksum,
                  YVEX_RENDER_FIELD_U64, NULL),
    SUMMARY_FIELD("layer_max_abs_diff", layer_max_abs_diff, YVEX_RENDER_FIELD_DOUBLE, NULL)};

static const yvex_render_field_spec prefill_cleanup_fields[] = {
    SUMMARY_FIELD("cleanup_attempted", cleanup_attempted, YVEX_RENDER_FIELD_BOOL, NULL),
    SUMMARY_FIELD("cleanup_status", cleanup_status, YVEX_RENDER_FIELD_TEXT, "not-needed")};

static const yvex_render_field_spec prefill_kv_fields[] = {
    SUMMARY_FIELD("kv_ready", kv_ready, YVEX_RENDER_FIELD_BOOL, NULL),
    SUMMARY_FIELD("session_kv_owned", session_kv_owned, YVEX_RENDER_FIELD_BOOL, NULL),
    SUMMARY_FIELD("kv_bound_to_prefill", kv_bound_to_prefill, YVEX_RENDER_FIELD_BOOL, NULL),
    SUMMARY_FIELD("kv_binding_kind", kv_binding_kind, YVEX_RENDER_FIELD_TEXT, "none"),
    SUMMARY_FIELD("kv_binding_source", kv_binding_source, YVEX_RENDER_FIELD_TEXT,
    ...
    SUMMARY_FIELD("kv_values_per_position", kv_values_per_position, YVEX_RENDER_FIELD_U64, NULL),
    SUMMARY_FIELD("kv_bytes_per_position", kv_bytes_per_position, YVEX_RENDER_FIELD_U64, NULL),
    SUMMARY_FIELD("kv_planned_bytes", kv_planned_bytes, YVEX_RENDER_FIELD_U64, NULL),
    SUMMARY_FIELD("kv_allocated_bytes", kv_allocated_bytes, YVEX_RENDER_FIELD_U64, NULL),
    SUMMARY_FIELD("kv_positions_written", kv_positions_written, YVEX_RENDER_FIELD_U64, NULL),
    SUMMARY_FIELD("kv_append_count", kv_append_count, YVEX_RENDER_FIELD_U64, NULL),
    SUMMARY_FIELD("kv_read_count", kv_read_count, YVEX_RENDER_FIELD_U64, NULL),
    SUMMARY_FIELD("kv_read_position", kv_read_position, YVEX_RENDER_FIELD_U64, NULL),
    SUMMARY_FIELD("kv_read_value_count", kv_read_value_count, YVEX_RENDER_FIELD_U64, NULL),
    SUMMARY_FIELD("kv_read_checksum", kv_read_checksum, YVEX_RENDER_FIELD_U64, NULL)};

static const yvex_render_field_spec prefill_kv_tail_fields[] = {
    SUMMARY_FIELD("kv_overflow", kv_overflow_status, YVEX_RENDER_FIELD_TEXT, "not-checked"),
    SUMMARY_FIELD("kv_cleanup_status", kv_cleanup_status, YVEX_RENDER_FIELD_TEXT, "not-needed")};

#undef SUMMARY_FIELD

/* Purpose: render one bounded F32 sample row through CLI-owned output. */
static void print_prefill_sample(const char *label, const float *values, unsigned long long count) {
    unsigned long long index;

    yvex_cli_out_writef(stdout, "%s:", label);
    for (index = 0; values && index < count; ++index)
        yvex_cli_out_writef(stdout, "%s%.9g", index ? "," : "", (double)values[index]);
...
static void print_prefill_state_summary(const yvex_prefill_state_summary *summary,
                                        const char *model_arg, const char *backend_name,
                                        const char *token_input_status, const char *status) {
    ...
    print_prefill_sample("layer_output_sample_values",
                         summary ? summary->layer_output_sample_values : NULL,
                         summary ? summary->layer_output_sample_count : 0ull);
    ...
    print_prefill_sample("kv_read_sample_values", summary ? summary->kv_read_sample_values : NULL,
                         summary ? summary->kv_read_sample_count : 0ull);
 ...
 * Failure: Typed refusal; outputs remain defined.
 * Boundary: No capability policy. */
static void init_prefill_summary_cli_defaults(
    yvex_prefill_state_summary *summary, const char *segment_name, int attach_kv,
    const yvex_kv_shape *shape, unsigned long long layer_count, unsigned long long chunk_size,
    unsigned long long position_start, unsigned long long context_length) {
    if (!summary) {
        return;
    }
    memset(summary, 0, sizeof(*summary));
    summary->prefill_state_kind =
        layer_count > 0ull ? "layer-backed-segment-summary" : "segment-summary";
    summary->sequence_execution_mode =
        layer_count > 0ull ? "segment-then-controlled-layer-fixture" : "independent-token-segments";
    ...
    summary->layer_sequence_rebuild =
        layer_count > 0ull ? "deterministic-with-previous-position-row" : "none";
    summary->layer_count = layer_count;
    summary->kv_binding_kind = attach_kv ? "minimal-diagnostic" : "none";
    summary->kv_binding_source =
        layer_count > 0ull ? "layer-final-sample" : "segment-output-sample";
 ...
 * Failure: Typed refusal; outputs remain defined.
 * Boundary: No capability policy. */
static int prefill_parse_number(int arg_count, char **args, int *index,
    ...
    if (*index + 1 >= arg_count || !(allow_zero ? parse_ull_allow_zero(args[*index + 1], value)
...
static int prefill_options_parse(int arg_count, char **args, prefill_cli_options *options) {
    ...
    for (i = 2; i < arg_count; ++i) {
        ...
        if (strcmp(args[i], "--attach-kv") == 0) {
            options->attach_kv = 1;
        } else if (strcmp(args[i], "--model") == 0 || strcmp(args[i], "--backend") == 0 ||
                   strcmp(args[i], "--segment") == 0 || strcmp(args[i], "--tokens") == 0) {
            const char *message =
                strcmp(args[i], "--model") == 0     ? "yvex: --model requires FILE_OR_ALIAS\n"
                : strcmp(args[i], "--backend") == 0 ? "yvex: --backend requires cpu|cuda\n"
                : strcmp(args[i], "--segment") == 0 ? "yvex: --segment requires embedding-rmsnorm\n"
                                                    : "yvex: --tokens requires IDS\n";
            const char **target = strcmp(args[i], "--model") == 0     ? &options->model
                                  : strcmp(args[i], "--backend") == 0 ? &options->backend
                                  : strcmp(args[i], "--segment") == 0 ? &options->segment
                                                                      : &options->tokens;
            if (i + 1 >= arg_count) {
...
static int prefill_options_validate(prefill_cli_options *options) {
    if (!options->model || !options->tokens || !options->segment) {
        yvex_cli_out_writef(stderr, "usage: yvex prefill --model FILE_OR_ALIAS --backend cpu|cuda "
                                    "--segment embedding-rmsnorm --"
                                    "tokens IDS [--layers N [--layer-hidden-dim N --layer-head-dim "
                                    "N --layer-ffn-dim N]] [--chunk-"
                                    "size N] [--position-start N] [--context-length N] "
                                    "[--attach-kv --kv-layers N --kv-heads N --"
    ...
    if (options->attach_kv &&
        (options->kv_shape.layer_count == 0ull || options->kv_shape.kv_head_count == 0ull ||
         options->kv_shape.head_dim == 0ull || options->kv_shape.capacity == 0ull)) {
        yvex_cli_out_writef(stderr, "yvex: --attach-kv requires --kv-layers, --kv-heads, "
    ...
    if (options->layer_count_seen &&
        (options->layer_hidden_seen || options->layer_head_seen || options->layer_ffn_seen) &&
        !(options->layer_hidden_seen && options->layer_head_seen && options->layer_ffn_seen)) {
        yvex_cli_out_writef(stderr, "yvex: custom layer dimensions require --layer-hidden-dim, "
    ...
    if (options->layer_count_seen &&
        ...
        yvex_cli_out_writef(
            stderr, "yvex: --layer-hidden-dim cannot exceed %u for sampled segment handoff\n",
...
static int command_prefill(int arg_count, char **args) {
    ...
    if (rc != YVEX_OK) {
        init_prefill_summary_cli_defaults(&prefill_summary, cli.segment, cli.attach_kv,
                                          &cli.kv_shape, cli.layer_count, cli.chunk_size,
                                          cli.position_start, cli.context_length);
        print_prefill_state_summary(&prefill_summary, cli.model, cli.backend, "fail",
                                    "prefill-state-fail");
    ...
    rc = yvex_graph_preflight(&model_ref, cli.backend, 0, 1, token_input.tokens[0], &graph_guard,
                              &err);
    if (rc != YVEX_OK) {
        init_prefill_summary_cli_defaults(&prefill_summary, cli.segment, cli.attach_kv,
                                          &cli.kv_shape, cli.layer_count, cli.chunk_size,
                                          cli.position_start, cli.context_length);
        prefill_summary.token_count = token_input.token_count;
        print_prefill_state_summary(&prefill_summary, cli.model, cli.backend, "pass",
                                    "prefill-state-fail");
...
int yvex_generate_command(int argc, char **argv) {
    ...
    if (report.loop_created) {
        (void)yvex_generate_render(yvex_cli_out_stdout(), args.render_mode, &report);
    }
    if (rc != YVEX_OK) {
        return print_yvex_error(&err, exit_for_status(rc));
    }
...
void yvex_prefill_help(FILE *fp) {
    yvex_cli_out_writef(fp, "usage: yvex prefill --model FILE_OR_ALIAS --backend cpu|cuda "
                            "--segment embedding-rmsnorm --tokens "
                            "IDS [--layers N [--layer-hidden-dim N --layer-head-dim N "
                            "--layer-ffn-dim N]] [--chunk-size N] [--"
                            "position-start N] [--context-length N] [--attach-kv --kv-layers N "
                            "--kv-heads N --kv-head-dim N --"
                            "kv-capacity N]\n\nPrefill records a segment-summary prefill "
                            "foundation from validated token input "
                            "and can bind processed positions to minimal KV ownership. "
                            "Layer-backed prefill uses the selected "
                            "embedding+RMSNorm segment plus a controlled layer fixture scheduler "
                            "over a sampled row. Chunked "
                            "prefill partitions validated token input into bounded diagnostic "
                            "chunks with explicit scratch and "
                            "context-boundary reporting. It is not full transformer prefill, "
                            "decode, logits, sampling, or "
                            "generation.\n");
}
