/*
 * model_artifacts.c - model-artifacts command adapter.
 *
 * Owner:
 *   src/cli/commands
 *
 ...
 */
#include "src/cli/input/model_artifacts.h"
#include "src/cli/render/model_artifacts.h"
#include "src/cli/model_artifacts/attention.h"
#include "src/cli/model_artifacts/context.h"
#include "src/cli/model_artifacts/fullmodel.h"
#include "src/cli/model_artifacts/models.h"
#include "src/cli/model_artifacts/moe.h"
#include "src/cli/model_artifacts/tensors.h"
