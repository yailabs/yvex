/*
 * yvex_model_artifacts_cli.c - model artifact command surfaces.
 *
 * Owner:
 *   src/cli/commands
 *
 ...
 *   dispatch surfaces while model artifact domain ownership is split out.
 *
 * Does not own:
 ...
 *
 * Invariants:
 *   existing command symbols and command syntax remain stable during topology
 *   extraction.
 *
 * Boundary:
