...
static const yvex_cli_command yvex_commands[] = {
    ...
    CMD("operator-contract","core","plumbing","Stable Operator protocol identity.","yvex operator-contract --output json","yvex operator-contract --output json","plumbing","protocol identity only; no backend/runtime capability",yvex_operator_contract_command,yvex_operator_contract_help),
