 ...
 *   - yvex_engine_close
 *   - engine accessors and summaries
 *
 * Invariants:
 *   - engine owns all opened parse/descriptor objects
 *   - partial graph status is explicit and diagnostic
 *   - no inference/session/backend execution is performed
 *
 * Commands:
 *   - make test-core
