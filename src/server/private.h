...
int yvex_server_engine_manager_finite_produce(server_engine_manager *,
    const yvex_finite_producer_request *, yvex_finite_producer_result *,
    int (*cancel_requested)(void *), void *cancel_context, yvex_error *);
