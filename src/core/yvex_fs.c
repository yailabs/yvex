...
static int command_paths(int arg_count, char **args)
{
    ...
    if (i < arg_count && strcmp(args[i], "configure") == 0) {
        ...
        if (want_reset) {
            ...
            fprintf(stdout, "status: paths-reset\n");
        ...
        fprintf(stdout, "status: paths-configured\n");
        fprintf(stdout, "models_root_source: %s\n", operator_paths.models_root_source);
        fprintf(stdout, "models_root: %s\n", operator_paths.models_root);
        fprintf(stdout, "hf_root: %s\n", operator_paths.hf_root);
        fprintf(stdout, "gguf_root: %s\n", operator_paths.gguf_root);
        fprintf(stdout, "reports_root: %s\n", operator_paths.reports_root);
        fprintf(stdout, "reference_root: %s\n", operator_paths.reference_root);
        fprintf(stdout, "registry_root: %s\n", operator_paths.registry_root);
        fprintf(stdout, "config_path: %s\n", operator_paths.config_path);
    ...
    if (i < arg_count && strcmp(args[i], "resolve") == 0) {
        ...
        fprintf(stdout, "status: paths-resolve\n");
        fprintf(stdout, "models_root_source: %s\n", operator_paths.models_root_source);
