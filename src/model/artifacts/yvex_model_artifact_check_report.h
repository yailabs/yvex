/*
 * yvex_model_artifact_check_report.h - typed model artifact check report.
 *
 * Owner:
 *   src/model/artifacts
 *
 * Owns:
 *   check report builder declaration for model artifacts.
 *
 * Does not own:
 ...
 *
 * Boundary:
 *   check reports are not runtime or release readiness evidence.
 */
#ifndef YVEX_MODEL_ARTIFACT_CHECK_REPORT_H
#define YVEX_MODEL_ARTIFACT_CHECK_REPORT_H
