...
static const yvex_cli_command yvex_commands[] = {
    { "accounts", "Inspect local provider account status.", yvex_accounts_command, yvex_accounts_help },
    ...
    { "fullmodel", "full model inventory, materialization, descriptor, and family-runtime reports.", yvex_fullmodel_command, yvex_fullmodel_help },
    ...
    { "moe", "MoE model-class reports and blockers.", yvex_moe_command, yvex_moe_help },
