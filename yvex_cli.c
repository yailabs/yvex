/*
 * yvex_cli.c - Command table and operator CLI dispatch.
 *
 * Command implementations live in private root-first CLI modules. This file
 * owns the public command table, help lookup, top-level dispatch, and main.
 */
