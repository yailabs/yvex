                                 ...
                                 const char *status)
{
    ...
    printf("logits: buffer\n");
    printf("status: logits-buffer\n");
    printf("model: %s\n", model_arg ? model_arg : "");
    printf("backend: %s\n",
    ...
    printf("bounded_logits_ready: %s\n",
           summary && summary->bounded_logits_ready ? "true" : "false");
    printf("real_model_logits: false\n");
    printf("real_model_output_head: false\n");
