 ...
 *
 * This file owns the current logits object skeleton and future logits buffer
 * diagnostics. It does not claim a logits-producing runtime path until graph
 * execution actually produces logits from runtime state.
 */
